package com.leekwok.msuser.jwt;
...
import io.jsonwebtoken.*;
  ...
  public class JwtOperator {
      ...
      public static void main(String[] args) {
          ...
          // 将我改成上面生成的token!!!
          String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODIyNjc5MTgsImV4cCI6MTU4MzQ3NzUxOH0.s0mCafpku8h60qsqH3JZSHKtVaL_J9nGPs8Wwceryjg";
          ...
          String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1ODIyNjc5MTgsImV4cCI6MTU4MzQ3NzUxOH0";
          // 测试5: 解密Payload
          byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
          System.out.println(new String(payload));

          // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
          jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODIyNjgwMjYsImV4cCI6MTU4MzQ3NzYyNn0.jm50o38pZ-xXUM17rPggIy8HKvpFGT_MHMb_LGNyB64");
      }
  }